...
from dgmeteo.command.common import CommandSupplier
from dgmeteo.command.metar import CommandSupplier as MetarCommandSupplier
from dgmeteo.command.remark import RemarkCommandSupplier
from dgmeteo.command.taf import TAFCommandSupplier
from dgmeteo.commons import converter
from dgmeteo.commons.exception import TranslationError
from dgmeteo.model.enum import Flag, Intensity, Descriptive, Phenomenon, TimeIndicator, WeatherChangeType
from dgmeteo.model.model import WeatherCondition, Visibility, Metar, TemperatureDated, \
