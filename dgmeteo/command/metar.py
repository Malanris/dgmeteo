...
from dgmeteo.commons.exception import ParseError
from dgmeteo.model.enum import DepositType, DepositCoverage
from dgmeteo.model.model import RunwayInfo, Metar
...
class AltimeterCommand:
    ...
    def execute(self, metar: Metar, input: str):
        ...
        :param metar: dgmeteo.model.model.Metar
        :param input: string
        :return:
        """
...
class RunwayCommand:
    ...
    def __parse_deposit_braking_capacity(self, input):
        ...
        if braking_capacity == 'DepositBrakingCapacity.//':
            return _(braking_capacity).format(input)
